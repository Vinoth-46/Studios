        ...
        <div className="foot-brand">
          ...
          <div className="foot-socials">
            ...
            <div className="foot-linkedin-wrapper">
              <button className="foot-social-trigger" aria-label="Team LinkedIn">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </button>
              <div className="linkedin-dropdown">
                <a href="https://www.linkedin.com/in/bpj45/" target="_blank" rel="noopener noreferrer">Praveen Joshwa</a>
                <a href="https://www.linkedin.com/in/tamilarasu55/" target="_blank" rel="noopener noreferrer">Tamilarasu V</a>
                <a href="https://www.linkedin.com/in/vinoth465/" target="_blank" rel="noopener noreferrer">Vinoth M</a>
              </div>
            </div>
          </div>
        </div>
